...
### Prop types and default props and shape
...
Modify the CSS to make the UI looks like the image below when displayDrawer is true (displays notificaitons at the far top right)
  Modify the CSS to make the UI looks like the image below when displayDrawer is false( only shows your notifications)
  modify the login when it is true it displays the list of courses when it is false it shows the prompt to login
